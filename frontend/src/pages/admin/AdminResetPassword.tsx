...
export default function AdminResetPassword() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    if (!token) {
      setErrorMessage("O link de recuperação é inválido ou está incompleto.");
    ...
    try {
      ...
      const response = await publicApiFetch("/admin-auth/reset-password", {
        method: "POST",
    ...
    <Section>
      <Container>
        <Card>
          ...
          <Text>
            Defina uma nova senha para recuperar o acesso ao painel
            administrativo da ROOM.
          </Text>
          ...
          <FooterActions>
            <LinkButton type="button" onClick={() => navigate("/admin/login")}>
              Voltar para o login
            </LinkButton>
          </FooterActions>
        </Card>
